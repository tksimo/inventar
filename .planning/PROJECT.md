...
- [x] User can add items by scanning a barcode with the phone camera — validated Phase 3 (2026-04-17): ScanFAB opens camera overlay, existing items show QuickUpdateSheet for one-tap quantity update, unknown barcodes pre-fill ItemDrawer from Open Food Facts with name/image/nutrition, works via HA ingress HTTPS on real mobile device
- [x] User can add items manually (name, quantity, category, location) — validated Phase 2 (2026-04-15): full CRUD via ItemDrawer with categories, storage locations, quantity tracking, and per-user attribution
...
| Barcode scanning via phone camera in webapp | No native app needed; @yudiel/react-qr-scanner via browser camera API | Validated Phase 3 |
...
---
*Last updated: 2026-04-17 after Phase 3 live verification*
